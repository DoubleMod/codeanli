...
public class MessageController extends BaseController{
    ...
    public Map sendTopic(@RequestParam("obj") JSONObject obj) {
    ...
    public Map sendDirect(@RequestParam("obj") JSONObject obj) {
        for (int i = 0; i < 10; i++) {
    ...
    public Map sendFanout(@RequestParam("obj") JSONObject obj) {
        for (int i = 0; i < 10; i++) {
