...
public class KeyPrefixConstants {
     ...
     * redis中，门禁修改密码
     */
    public static final String REDIS_SMS_MODIFY_DOOR_PASSWORD_KEY_PREFIX =
            "applet:sms:door:password:";
    /**
     * redis中，门禁邀请
     */
     ...
     * redis中，applet修改手机号
     */
    public static final String REDIS_APPLET_MODIFYPHONE_VERIFY_KEY_PREFIX =
            "applet:modifyphone:verify:";
    /**
     * redis中，搜索记录缓存
     */
