...
//@MapperScan(value = "com.code.anli.dao.*")
public class CodeanliApplication  {
    private Logger logger = Logger.getLogger(SpringBootServletInitializer.class);
...
//            logger.info("Logger path is: " + loggerAdess);
